...
<html profile="http://gmpg.org/xfn/11">
	...
	<body>
		...
		<?php } ?>
		<div id="context">
				<img src="../../static/images/step_1.png" class="step" />
				<form method="post">
					<input class="email" type="text" name="email" value="请输入您的email"  onMouseOver="this.focus()" onMouseOut="if(this.value=='')this.value='请输入您的email';" onFocus="this.select()" onClick="if(this.value=='请输入您的email')this.value=''" />
			<!--添加提交按钮-->	
			<input type="image" name = "step1" src="../../static/images/register.png" class = "command"/>
			<!--添加结束-->
				</form>		
