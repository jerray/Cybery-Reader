...
<html profile="http://gmpg.org/xfn/11">
	...
	<body>
		...
		<?php } ?>
		<div id="context">
			<img src="../../static/images/step_3.png" class="step" />
			<form method="post">
				<input class="realname" type="text" name="alias" value="请输入您的真实姓名"  onMouseOver="this.focus()" onMouseOut="if(this.value=='')this.value='请输入您的真实姓名';" onFocus="this.select()" onClick="if(this.value=='请输入您的真实姓名')this.value=''">
			<!--添加提交按钮-->
			<input type="image" name = "step2" src="../../static/images/complete.png" class = "command"/>
			<!--添加结束-->
			</form>
